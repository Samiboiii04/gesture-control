    ...
    if id==1:
        while inloop==1:
            ...
            if inid==1:
                ...
                os.system('C:/Users/samru/Desktop/finalproject/PCode/1H/Detection1H.py')
                ...
                print('---------------------------------')
                os.system('C:/Users/samru/Desktop/finalproject/PCode/1H/Dynamic.py')
                print('---------------------------------')
                ...
                print('--------------------------------')
                os.system('C:/Users/samru/Desktop/finalproject/PCode/1H/Static.py')
                print('--------------------------------')
        ...
        while inloop==1:
            ...
            if inid==1:
                ...
                print('Starting Gesture Detection')
                print('--------------------------')
                os.system('C:/Users/samru/Desktop/finalproject/PCode/2H/Detection.py')
                print('-------------------------')
                print('Gesture Detection Stopped')
                print('-------------------------')
                time.sleep(2)
                ...
                print('Starting Dynamic Gesture Training')
                print('---------------------------------')
                os.system('C:/Users/samru/Desktop/finalproject/PCode/2H/Dynamic.py')
                print('---------------------------------')
                print('Dynamic Gesture Training Stopped')
                print('---------------------------------')
                time.sleep(2)
                ...
                print('Starting Static Gesture Training')
                print('---------------------------------')
                os.system('C:/Users/samru/Desktop/finalproject/PCode/2H/Static.py')
                print('---------------------------------')
                print('Static Gesture Training Stopped')
                print('---------------------------------')
                time.sleep(2)
